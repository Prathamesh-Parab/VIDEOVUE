...
import { SLMenu, SlMenu } from "react-icons/sl";
        ...
        <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
            ...
            <div className="group flex items-center">
                <div className="flex h-8 md:h-10 md:ml-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0">
                    ...
                    <input type="text"
                        className='outline-none bg-transparent text-white pr-5 pl-5 md:pl-0 w-44 md:group-focus-within:pl-0 md:w-64 lg:w-[500px]'
                        placeholder='Search'
            ...
            <div className="flex items-center">
                ...
                <div className="flex rounded-2xl h-[45px] pl-1 pr-1 border border-[#656464] items-center justify-between w-[100px] cursor-pointer">
